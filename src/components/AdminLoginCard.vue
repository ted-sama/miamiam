    ...
    <div class="flex justify-center items-center min-h-screen">
      <div class="w-96">
        <div class="bg-white p-8 rounded-lg sm:shadow-lg">
          ...
          <h1 class="text-3xl font-medium text-center mb-2">Se connecter</h1>
          <div class="flex justify-center">
            <h3
              class="inline-flex text-center mb-14 px-4 py-1 rounded-full bg-neutral-900/10"
            >
              <Shield class="mr-2" />
          ...
          <form @submit.prevent="login" class="space-y-4">
            <div>
              ...
              />
              <p v-show="emailWarning != ''" class="mt-2 text-sm text-red-600">
                {{ emailWarning }}
              </p>
            </div>
            <div>
